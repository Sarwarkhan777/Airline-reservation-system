                    ...
                    <ul id="menu">
                        ...
                        <li><a href="airlinedetails.jsp"><span><span>Airline Details<span></span></a></li>
                                        ...
                                        <table  border="2" align="center" cellpadding="2" cellspacing="2" width="50%">
                                            <tr><td><center><font size="+3" color="GREEN"> BOOKING DETAILS</center></td>
                                            </tr>
...
//                                                    String customerid = rs.getString(7);
                                            ...
                                            <table bordercolor="black" border="3" align="center" cellpadding="2"
                                                ...
                                                <TR>
                                                    <TD><font size="+4" color="green"></b><center>bookingid</center></td>
                                                <td><font size="+4" color="green"></b><center>airlineid</center></td>
                                                <td><font size="+4" color="green"></b><center>departure</center></td>
                                                <TD><font size="+4" color="green"></b><center>destination </center></td>
                                                <td><font size="+4" color="green"></b><center>bookingdate</center></td>
                                                <td><font size="+4" color="green"></b><center>price </center></td>
                                                <td><font size="+2" color="green"></b><center>customerid  </center></td>
                                                ...
                                                <td><font size="+1" color="BLUE"></b><center><%=rs.getString(7)%></center>
                                                </tr>
                                                <font size="+2" color="red"></b><a href="cancellde.jsp">Booking Cancelation</a>
                                                    <% } %>
                                                    <%
