...
<div class="main">
  ...
  <table  border="2" align="center" cellpadding="2" cellspacing="2" width="50%">
      <tr><td><center><font size="+3" color="GREEN">AIRLINE DETAILS</center></td>
      </tr>
...
String QueryString = "SELECT * from  airlinedetails";
...
<table bordercolor="black" border="3" align="center" cellpadding="2"
    ...
    <TR>
        <TD><font size="+4" color="red"></b><center>Airlineid</center></td>
        <td><font size="+2" color="red"></b><center>Airlinename</center></td>
        <td><font size="+2" color="red"></b><center>departure </center></td>
        <TD><font size="+2" color="red"></b><center>destination </center></td>
        <td><font size="+2" color="red"></b><center>fare</center></td>
        <td><font size="+2" color="red"></b><center>journeydate</center></td>
